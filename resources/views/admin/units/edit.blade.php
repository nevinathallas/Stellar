        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header bg-warning">
                    <h4 class="mb-0 text-dark"><i class="bi bi-pencil"></i> Edit Unit Planet</h4>
                </div>
                    ...
                    <form action="{{ route('admin.units.update', $unit) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                   id="code" name="code" value="{{ old('code', $unit->code) }}" 
                                   required autofocus>
                            @error('code')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control @error('image_url') is-invalid @enderror" 
                                   id="image_url" name="image_url" value="{{ old('image_url', $unit->image_url) }}" 
                            ...
                            @if($unit->image_url)
                                <div class="mt-2">
                                    <small class="text-muted">Preview gambar saat ini:</small>
                                    <div class="mt-1">
                                        <img src="{{ $unit->image_url }}" alt="{{ $unit->name }}" 
                                             style="max-width: 200px; max-height: 150px; border-radius: 0.5rem;">
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="border rounded p-3" style="max-height: 250px; overflow-y: auto;">
                                @php
                                    $selectedCategories = old('categories', $unit->categories->pluck('id')->toArray());
                                @endphp
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-warning text-dark">
                                <i class="bi bi-save"></i> Update Unit
                            </button>
